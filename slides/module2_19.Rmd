...
In the previous module we discussed how `.loc[]` returns only specified columns and rows of the dataframe. 
...
2. Once we have obtained our desired rows we replace their values in either a specified column or create a new column all together.       
...
Lastly, we need to specify what we want to change the values to.  In our case, we are replacing "Q" with "Quaker".
