...
Chaining is used specifically with methods and cannot be used with functions.  We have made the comparison that attributes are as nouns, as methods and functions are to verbs. 
...
1. Filter our dataframe for cereals only from manufacturer "K" -> The results of this action is our object for the next method. 
