...
This means that the actual fat content of each cereal is actually an additional 2 grams.  How can we rectify this?
...
Just like we did earlier in module, we need to save the dataframe to an object when making changes involving columns. This will permanently save the column `weight_g` to the dataframe `df`. 
...
This time we want to save our sugar content per cereal cup as a column in our exisiting dataframe. 
...
That's not so bad right? Give it a shot in the exercises now on your own.
