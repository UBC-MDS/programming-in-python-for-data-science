...
There will be times where you are unsatisfied with the column names and you want want to change them. The proper syntax to do that is with `df.rename()`.    
...
It's important that we always save the dataframe to an object or the column will not be saved in our dataframe.
...
Again make sure that we always save the dataframe to an object or the column will not be deleted from the dataframe.
