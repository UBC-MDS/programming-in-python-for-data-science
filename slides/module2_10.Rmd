...
Python will now move from left to right and in this case it will select all the cereals with a fiber content greater than 6 *or* all the cereal satisfying a protein content above 5 made by "K" manufacturer. 
