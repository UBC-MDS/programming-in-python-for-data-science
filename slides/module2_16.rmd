...
Double equal signs,  `==`,  is a used in python for comparison. We check if certain values are equivalent to one another. 
...
Perhaps we only want cereals with a protein content between 4 to 5 grams?
...
Filtering this time resulted in 10 cereals meeting either of the conditions instead of only 1 cereal when both condition needed to be met. 
