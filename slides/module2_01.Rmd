...
You can see the whole course structure and it's subdirectories <a href="https://github.com/UBC-MDS/MCL-DSCI-511-programming-in-python" target="_blank">openly online</a>. It may also be a good idea to look in the  <a href="https://github.com/UBC-MDS/MCL-DSCI-511-programming-in-python/tree/master/data" target="_blank">data folder</a> data folder to see exactly where the data you are loading in the exercises is coming from. 
