...
Since exponent takes the second argument position omitting the `exponent=` part will result in the same output.
...
Functions can have any number of arguments and any number of optional arguments but we must be careful with the order arguments are defined and called. 

When we defined our arguments in a function, all arguments with default values need to be defined ***after*** required arguments. 
