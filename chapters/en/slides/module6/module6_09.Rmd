...
Currently many people in the Python community are writing docstrings in different ways, the most common uses a formatting style called ***ReStructuredText.*** 
...
It's not an uncommon opinion that this isn't exactly easy to read, and so new formats have began to come into fruition.
