...
We can identify the breif description of the function at the top, the parameters that it takes in and what object type they should be, as well as what to expect as an output. 
...
Although it's highly advised against, there could be occasions where it's unavoidable or required.
