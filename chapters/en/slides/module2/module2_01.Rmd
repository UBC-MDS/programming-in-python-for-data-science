...
<center> <img src='/module2/url-samp.png'  alt="404 image"  width="60%" height="60%" align="middle"/></center>
...
This is not ideal. What you should notice is instead of each column value being separated by a column, it is now separated by `\t`.   
...
<center> <img src='/module2/datafile.png'  alt="404 image"  width="80%" align="middle"/></center>
...
It may be a good idea to look in the  <a href="https://github.com/UBC-MDS/MCL-DSCI-511-programming-in-python/tree/master/data" target="_blank">data folder</a> data folder to see exactly where the data you are loading in the exercises is coming from. 
