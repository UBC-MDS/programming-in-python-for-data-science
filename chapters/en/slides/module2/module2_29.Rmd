...
This gives us a lot more control over the customization of our plot. You'll see this coming up. 
...
Here we seem to have lost our index column of numbers we usually have and it appears that `mfr` has now moved to the left of the dataframe with its label `mfr` lower than the other column labels.
