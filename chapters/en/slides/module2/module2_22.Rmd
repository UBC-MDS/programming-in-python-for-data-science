...
Instead of saving the column in advance, we can skip this step and make the frequency table in one line, with chaining.
...
We can do this by wrapping our code in parentheses and making a new line before each period (`.`).  
...
Some argue that it can add restrictions to your code. One thing that is for certain the readability of the code written. 
