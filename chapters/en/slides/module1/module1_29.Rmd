...
If we used double square brackets with `pd.value_counts()` we would get an error so it's important to take care with using the correct number of square brackets.
