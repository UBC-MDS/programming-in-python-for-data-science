...
At this point of the module, we know how to get a subset of an existing dataframe but what if we just want to get a single value from it?
...
Again we use `.loc[]`, specify the row and the column location separated by a comma.
