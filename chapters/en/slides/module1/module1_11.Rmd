...
We would simply use `:` to indicate from "end" to "end" for our rows rows:
...
- However, the reverse is not true. If we want all the rows with only specific columns, we specify rows first and therefore we would need to make it clear with 
```python
