...
<center> <img src='/module1/df_var.png' width="65%" alt="404 image" /></center>
...
The first kind of data we will learn how to load into Python (as a dataframe) is the spreadsheet-like comma-separated values format (.csv for short). These files have names ending in .csv, and can be opened open and saved from common spreadsheet programs like Microsoft Excel and Google Sheets.
