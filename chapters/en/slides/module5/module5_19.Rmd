...
We wrote which created a new list containing the square of the elements into code that was written with much less repeated code. 
...
The `return` statement is crucial to a function for returning a desired output.  
...
This function  now is recycled on all of our lists and meets the DRY principle.
