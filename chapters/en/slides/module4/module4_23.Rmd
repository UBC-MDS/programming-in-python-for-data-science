...
To convert this into tidier data we will need to split up this column into 2 separate ones, but how?
...
First, we need to isolate the column and make sure we are splitting on the correct separator. 
