...
sentence.split("e")
```
This argument uses the character "e" to separate string are and discards the separator. 
...
Sets, not unlike lists and tuples is a data structure that contain elements. Sets differ such that:
- they are unordered, and
