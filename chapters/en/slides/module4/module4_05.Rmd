...
my_set[1]
```
Remember this data structure has no order, so Python displays them according to some internal sorting scheme.  
...
You'll notice that unlike lists, the new entries are not added to the end since this data structure has no order.  
