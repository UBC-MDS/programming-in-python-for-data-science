...
Similarly to how a string is a sequence of characters that depend on an order, a list is a sequence of elements with a particular order. Lists can be identified by their square brackets.
...
You'll notice that unlike lists, the new entries are not added to the end.  
