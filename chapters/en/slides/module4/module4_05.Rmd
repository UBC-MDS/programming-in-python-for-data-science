...
Sets, not unlike lists and tuples is a data structure that contains elements. Sets differ such that:
...
You'll notice that unlike lists, the new entries are not added to the end. Remember this data structure has no order.  
