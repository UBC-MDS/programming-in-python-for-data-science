...
There are two ways of doing so; with single brackets, and with double brackets.  

Double bracket don't surprise us and produce an object of type `pd.DataFrame`. 
...
In fact, the <a href="https://pandas.pydata.org/pandas-docs/stable/getting_started/dsintro.html#dataframe" target="_blank">Pandas documentation"</a> explain it as "a dict of Series objects". 
...
An easy way tocheck all dtypes of the columns in our dataframe is to use `.dtypes` on the dataframe object. 
