...
A pandas Series is a one dimension array of values with an axis label. This is the base data type that make up a pandas dataframe. In fact, the <a href="https://pandas.pydata.org/pandas-docs/stable/getting_started/dsintro.html#dataframe" target="_blank"Pandas documentation"</a> explain it as "a dict of Series objects". 
...
Just like with Python data types, Pandas has numeric and non numeric datatypes. 
...
Also a `bool`. We can ignore the numpy like we did before, we will discuss this later. 
...
cereal.dtypes
```
Knowing what type values are, helps us understand how we can transform them and how they respond to different operations and operators. 
