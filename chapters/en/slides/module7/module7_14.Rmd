...
Here are some basic guidelines according to PEP8 and <a href="https://www.python.org/dev/peps/pep-0008/#comments" target="_blank">python.org</a> that are recommended when writing comment:
...
```
 ...
 That being said being consistent and setting standards now, helps the python community, your code and future coding. 
...
This will create a multitude of problems for you, is bad coding practice and will eventually break your code. 
