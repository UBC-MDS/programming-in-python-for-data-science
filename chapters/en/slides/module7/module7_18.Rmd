...
The piece of code we are going to examine is a function called `random_walker`. This function simulates a random walk in two dimensions - so you can walk in any of four directions up, down, left, or right, and each one has a 1/4 chance of occurring.
