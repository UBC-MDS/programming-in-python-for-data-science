...
<br>
<br>
<center><img src='/module3/problem_table.png' width="80%"></center>
...
We can obtain the duplicated rows by filtering on them from the original dataframe `cereal_problem`.
