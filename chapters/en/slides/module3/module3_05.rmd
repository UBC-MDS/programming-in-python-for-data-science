...
In this case, it makes the most sense for our data to have the measurements `area` and `population` as variables that may or may not affect language diversity. This would be considered tidy data and it is stored as a wider dataframe than what what initially presented to us. 
