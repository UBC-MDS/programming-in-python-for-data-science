...
**Long**
<center><img src='/module3/long.png' width="35%"></center>
...
<center><img src='/module3/wide-long1.png' width="50%"></center>
...
In this case, it makes more sense to have our data displayed in a wide format, so we can measure `area` and `population` as variables that may or may not affect language diversity. 


<center><img src='/module3/wide-long2.png' width="50%"></center>
...
We are intested in the variable `year` which makes a long dataframe (with a single column for the variable `year`) tidy and the most appropriate to use in our analysis. 

<center><img src='/module3/wide-long4.png' width="30%"></center>
