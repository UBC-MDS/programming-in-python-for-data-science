...
We mentioned that the default argument value`inner` which will only keep the rows with identifying column values that are present in both dataframes.
...
Notes: Let's colour coordinate this table and explore it on the next slide. 
