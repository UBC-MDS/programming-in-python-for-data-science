...
Programming in Python is the prerequisite course in the Key Capabilities in Data Science program, and you must obtain 70% or higher in Programming in Python to obtain a course completion grade and proceed to the next course in the program. To successfully complete the Key Capabilities in Data Science program, you must complete all four required courses and achieve 70% or higher for each of the four courses. 
