...
:::{.notes}
In the last section we learned about tidy data and how it is determined based on what we are trying to figure out, e.g. what our statistical question is.
