...
If we think about this a bit, it actually makes some sense. Think about the calculation `6 - 2 = 4`. We get 4 items remaining which is the amount of cereals we want in our in new dataframe.
:::
