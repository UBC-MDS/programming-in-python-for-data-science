...
<script>
    generateQuiz(
        'mcq3',
        'Question 2',
        'If I make a function call using the above code, and I know that parameter <code>spice_level</code> is an argument that has a default value, which other arguments <b>MUST</b> also have set default values?',
        {
